...
interface IPassageService_ICreateStandardTunnel extends grpc.MethodDefinition<service_pb.CreateStandardTunnelRequest, service_pb.Tunnel> {
    ...
    responseSerialize: grpc.serialize<service_pb.Tunnel>;
    responseDeserialize: grpc.deserialize<service_pb.Tunnel>;
}
interface IPassageService_ICreateReverseTunnel extends grpc.MethodDefinition<service_pb.CreateReverseTunnelRequest, service_pb.Tunnel> {
...
export interface IPassageServer extends grpc.UntypedServiceImplementation {
    createStandardTunnel: grpc.handleUnaryCall<service_pb.CreateStandardTunnelRequest, service_pb.Tunnel>;
    createReverseTunnel: grpc.handleUnaryCall<service_pb.CreateReverseTunnelRequest, service_pb.Tunnel>;
...
export interface IPassageClient {
    createStandardTunnel(request: service_pb.CreateStandardTunnelRequest, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    createStandardTunnel(request: service_pb.CreateStandardTunnelRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    createStandardTunnel(request: service_pb.CreateStandardTunnelRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    createReverseTunnel(request: service_pb.CreateReverseTunnelRequest, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    createReverseTunnel(request: service_pb.CreateReverseTunnelRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    createReverseTunnel(request: service_pb.CreateReverseTunnelRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
...
export class PassageClient extends grpc.Client implements IPassageClient {
    ...
    public createStandardTunnel(request: service_pb.CreateStandardTunnelRequest, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    public createStandardTunnel(request: service_pb.CreateStandardTunnelRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    public createStandardTunnel(request: service_pb.CreateStandardTunnelRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    public createReverseTunnel(request: service_pb.CreateReverseTunnelRequest, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    public createReverseTunnel(request: service_pb.CreateReverseTunnelRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
    public createReverseTunnel(request: service_pb.CreateReverseTunnelRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: service_pb.Tunnel) => void): grpc.ClientUnaryCall;
